...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrintJobs : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintJobs" /> class.
        /// </summary>
        ...
        public PrintJobs(string nextToken = default(string), List<PrintJob> items = default(List<PrintJob>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for PrintJobs and cannot be null");
            }
            this.Items = items;
