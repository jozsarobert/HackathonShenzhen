...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WorkspacePrinterInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspacePrinterInput" /> class.
        /// </summary>
        ...
        public WorkspacePrinterInput(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for WorkspacePrinterInput and cannot be null");
            }
            this.Name = name;
        }
