...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrintJobStatuses : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintJobStatuses" /> class.
        /// </summary>
        ...
        public PrintJobStatuses(string nextToken = default(string), List<PrintJobStatus> items = default(List<PrintJobStatus>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for PrintJobStatuses and cannot be null");
            }
            this.Items = items;
