...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WorkspaceSpaces : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceSpaces" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="WorkspaceSpaces" /> class.
        /// </summary>
        /// <param name="total">The total number of Spaces in all pages of results.</param>
        /// <param name="nextToken">Pagination token.</param>
        /// <param name="items">items (required).</param>
        public WorkspaceSpaces(int total = default(int), string nextToken = default(string), List<Space> items = default(List<Space>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for WorkspaceSpaces and cannot be null");
            }
            this.Items = items;
            this.Total = total;
        ...
        /// <summary>
        /// The total number of Spaces in all pages of results
        /// </summary>
        /// <value>The total number of Spaces in all pages of results</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceSpaces {\n");
