...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FacilityAssetGroups : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FacilityAssetGroups" /> class.
        /// </summary>
        ...
        public FacilityAssetGroups(string nextToken = default(string), List<AssetGroup> items = default(List<AssetGroup>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for FacilityAssetGroups and cannot be null");
            }
            this.Items = items;
