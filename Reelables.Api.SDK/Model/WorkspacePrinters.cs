...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WorkspacePrinters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspacePrinters" /> class.
        /// </summary>
        ...
        public WorkspacePrinters(string nextToken = default(string), List<WorkspacePrinter> items = default(List<WorkspacePrinter>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for WorkspacePrinters and cannot be null");
            }
            this.Items = items;
