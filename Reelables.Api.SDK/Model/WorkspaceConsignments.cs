...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WorkspaceConsignments : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceConsignments" /> class.
        /// </summary>
        ...
        public WorkspaceConsignments(string nextToken = default(string), List<Consignment> items = default(List<Consignment>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for WorkspaceConsignments and cannot be null");
            }
            this.Items = items;
