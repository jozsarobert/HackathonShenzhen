...
namespace Org.OpenAPITools.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class WorkspacePrintTemplatesApi : IWorkspacePrintTemplatesApi
    {
        ...
        /// <returns></returns>
        public WorkspacePrintTemplatesApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public WorkspacePrintTemplatesApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspacePrintTemplates> localVarResponse = WorkspacesWorkspaceIdPrintTemplatesGetWithHttpInfo(workspaceId, requestId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WorkspacePrintTemplates</returns>
        public Org.OpenAPITools.Client.ApiResponse<WorkspacePrintTemplates> WorkspacesWorkspaceIdPrintTemplatesGetWithHttpInfo(string workspaceId, string? requestId = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'workspaceId' when calling WorkspacePrintTemplatesApi->WorkspacesWorkspaceIdPrintTemplatesGet");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspacePrintTemplates> localVarResponse = await WorkspacesWorkspaceIdPrintTemplatesGetWithHttpInfoAsync(workspaceId, requestId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkspacePrintTemplates)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<WorkspacePrintTemplates>> WorkspacesWorkspaceIdPrintTemplatesGetWithHttpInfoAsync(string workspaceId, string? requestId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
