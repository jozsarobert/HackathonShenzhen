...
namespace Org.OpenAPITools.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class WorkspaceSpacesApi : IWorkspaceSpacesApi
    {
        ...
        /// <returns></returns>
        public WorkspaceSpacesApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public WorkspaceSpacesApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> localVarResponse = WorkspacesWorkspaceIdSpacesGetWithHttpInfo(workspaceId, requestId, limit, nextToken, searchTerm);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WorkspaceSpaces</returns>
        public Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> WorkspacesWorkspaceIdSpacesGetWithHttpInfo(string workspaceId, string? requestId = default(string?), string? limit = default(string?), string? nextToken = default(string?), string? searchTerm = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'workspaceId' when calling WorkspaceSpacesApi->WorkspacesWorkspaceIdSpacesGet");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> localVarResponse = await WorkspacesWorkspaceIdSpacesGetWithHttpInfoAsync(workspaceId, requestId, limit, nextToken, searchTerm, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkspaceSpaces)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces>> WorkspacesWorkspaceIdSpacesGetWithHttpInfoAsync(string workspaceId, string? requestId = default(string?), string? limit = default(string?), string? nextToken = default(string?), string? searchTerm = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> localVarResponse = WorkspacesWorkspaceIdSpacesPostWithHttpInfo(workspaceId, workspaceSpacesInput, requestId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WorkspaceSpaces</returns>
        public Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> WorkspacesWorkspaceIdSpacesPostWithHttpInfo(string workspaceId, WorkspaceSpacesInput workspaceSpacesInput, string? requestId = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'workspaceId' when calling WorkspaceSpacesApi->WorkspacesWorkspaceIdSpacesPost");
            }

            // verify the required parameter 'workspaceSpacesInput' is set
            if (workspaceSpacesInput == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'workspaceSpacesInput' when calling WorkspaceSpacesApi->WorkspacesWorkspaceIdSpacesPost");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<WorkspaceSpaces> localVarResponse = await WorkspacesWorkspaceIdSpacesPostWithHttpInfoAsync(workspaceId, workspaceSpacesInput, requestId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
