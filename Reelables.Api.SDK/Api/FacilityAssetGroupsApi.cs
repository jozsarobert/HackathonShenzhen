...
namespace Org.OpenAPITools.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class FacilityAssetGroupsApi : IFacilityAssetGroupsApi
    {
        ...
        /// <returns></returns>
        public FacilityAssetGroupsApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public FacilityAssetGroupsApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<FacilityAssetGroups> localVarResponse = FacilitiesFacilityIdAssetGroupsGetWithHttpInfo(facilityId, requestId, limit, nextToken);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FacilityAssetGroups</returns>
        public Org.OpenAPITools.Client.ApiResponse<FacilityAssetGroups> FacilitiesFacilityIdAssetGroupsGetWithHttpInfo(string facilityId, string? requestId = default(string?), string? limit = default(string?), string? nextToken = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'facilityId' is set
            if (facilityId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'facilityId' when calling FacilityAssetGroupsApi->FacilitiesFacilityIdAssetGroupsGet");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<FacilityAssetGroups> localVarResponse = await FacilitiesFacilityIdAssetGroupsGetWithHttpInfoAsync(facilityId, requestId, limit, nextToken, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FacilityAssetGroups)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<FacilityAssetGroups>> FacilitiesFacilityIdAssetGroupsGetWithHttpInfoAsync(string facilityId, string? requestId = default(string?), string? limit = default(string?), string? nextToken = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'facilityId' is set
            if (facilityId == null)
            {
