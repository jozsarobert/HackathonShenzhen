...
{ 
    ...
    /// </summary>
    [ApiController]
    public class AssetTemperaturesApiController : ControllerBase
    { 
        /// <summary>
        ...
        /// <param name="limit">Number of temperatures to return. Default: 10. Maximum: 10000</param>
        /// <param name="nextToken">Pagination token to get next page of temperatures</param>
        ...
        [HttpGet]
        [Route("/v1/assets/{assetId}/temperatures")]
        [ValidateModelState]
        [SwaggerOperation("AssetsAssetIdTemperaturesGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(AssetTemperatures), description: "200 response")]
        ...
        public virtual IActionResult AssetsAssetIdTemperaturesGet([FromRoute (Name = "assetId")][Required]string assetId, [FromHeader (Name = "request-id")]string requestId, [FromQuery (Name = "limit")]string limit, [FromQuery (Name = "nextToken")]string nextToken)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(AssetTemperatures));
            ...
            ? JsonConvert.DeserializeObject<AssetTemperatures>(exampleJson)
            : default(AssetTemperatures);
