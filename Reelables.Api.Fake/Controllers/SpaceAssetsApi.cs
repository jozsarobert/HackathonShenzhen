...
{ 
    ...
    /// </summary>
    [ApiController]
    public class SpaceAssetsApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpGet]
        [Route("/v1/spaces/{spaceId}/assets")]
        [ValidateModelState]
        [SwaggerOperation("SpacesSpaceIdAssetsGet")]
        ...
        public virtual IActionResult SpacesSpaceIdAssetsGet([FromRoute (Name = "spaceId")][Required]string spaceId, [FromHeader (Name = "request-id")]string requestId, [FromQuery (Name = "limit")]string limit, [FromQuery (Name = "nextToken")]string nextToken)
        {
