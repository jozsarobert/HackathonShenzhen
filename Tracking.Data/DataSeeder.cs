...
namespace Tracking.Data
{
    public class DataSeeder
    {
        ...
        public DataSeeder()
        {
            ...
            var logisticsAction = GetLogisticsAction();
            var logisticsActivity = GetLogisticsActivity();
            var logisticsAgent = GetLogisticsAgent();
            var logisticsObject = GetLogisticsObject();
            var logisticsService = GetLogisticsService();
            var measurement = GetMeasurement();
            var movementTimes = GetMovementTimes();
        ...
        //private static List<Piece> GetPieces(double weight)
        //{
        ...
        //    };
        //}
        //private static Value GetTotalGrossWeight(double totalWeight)
        //{
        //    return new Value  
        //                {
        //                    NumericalValue = totalWeight,
        //                    Unit = "Kg",
        //                    DimensionId = "",
        //                };
        //}
